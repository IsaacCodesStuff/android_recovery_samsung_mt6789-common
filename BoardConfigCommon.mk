...
# Add this patch only to A07/M07 BoardConfig.mk because of JDM; A17 will not benefit from this
# TW_USE_SAMSUNG_JDM_HAPTICS := true

# Add this patch only to A17 BoardConfig.mk; A07/M07 will not benefit from this
